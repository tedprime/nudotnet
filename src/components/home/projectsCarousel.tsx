...
const ProjectCarousel = ({ slides }: { slides: TrainingHighlightData[] }) => {
  return (
          ...
          <CarouselContent>
            {slides.map((slide) => (
              ...
              >
                ...
                <div className="absolute inset-0 z-20 flex h-full w-full flex-col justify-end gap-4 px-6 pb-8 md:px-12">
                  <h3 className="text-2xl font-semibold uppercase text-white md:text-3xl lg:text-4xl">
                    {slide.title}
                  </h3>
