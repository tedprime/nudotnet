...
type Props = { image: string; eyebrow: string; body: string; alt?: string };

// Shared presentational shell for the site's full-screen page heroes —
// SolutionsHero, AboutHero, WorkHero all just fetch a PageHero row and
// hand it to this component.
export const PageHeroSection = ({ image, eyebrow, body, alt }: Props) => {
  return (
      ...
      <div className="h-full w-full">
        <div className="relative h-full w-full">
          ...
          <div className="absolute inset-0 mx-auto mb-0 mt-auto flex h-fit w-full max-w-[800px] flex-col items-center justify-center rounded-none bg-black/20 py-16 backdrop-blur-md lg:mb-20 lg:rounded-2xl">
            <p className="text-white/50">{eyebrow}</p>
