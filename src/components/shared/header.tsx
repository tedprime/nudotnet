          ...
          <div className="relative">
            <ul className="group flex flex-1 list-none items-center justify-center space-x-3 px-2 text-white">
              <li>
                <Link
                  href={'/'}
                  className={`group inline-flex h-10 w-max items-center justify-center !rounded-full px-4 py-2 text-sm font-bold transition-colors hover:text-[#ef6e11] focus:outline-none ${pathname === '/' ? 'bg-white/70 text-black' : ''}`}
                >
                  Home
                </Link>
              </li>
              <li>
                <Link
                  href={'/about'}
                  className={`group inline-flex h-10 w-max items-center justify-center !rounded-full px-4 py-2 text-sm font-bold transition-colors hover:text-[#ef6e11] focus:outline-none ${pathname === '/about' ? 'bg-white/70 text-black' : ''}`}
                >
                  About Us
                </Link>
              </li>
              <li>
                <Link
                  href={'/projects'}
                  className={`group inline-flex h-10 w-max items-center justify-center !rounded-full px-4 py-2 text-sm font-bold transition-colors hover:text-[#ef6e11] focus:outline-none ${pathname === '/projects' ? 'bg-white/70 text-black' : ''}`}
                >
                  Our Projects
                </Link>
              </li>
              <li>
                <Link
                  href={'/contact'}
                  className={`group inline-flex h-10 w-max items-center justify-center !rounded-full px-4 py-2 text-sm font-bold transition-colors hover:text-[#ef6e11] focus:outline-none ${pathname === '/contact' ? 'bg-white/70 text-black' : ''}`}
                >
                  Contact
                </Link>
              </li>
